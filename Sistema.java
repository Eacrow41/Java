...
public class Sistema{
  public static void main(String args[]){
   ...
   System.out.println("********************************************");
   System.out.println("Bienvenido al sistrema vacacional de Coca-Cola");
   System.out.println("********************************************");
   System.out.println("");
   System.out.println("");
   ...
   System.out.println("Cuanto tiempo tiene de servicio el trabajador?");
   antiguedad = entrada.nextInt();
   System.out.println("");

   System.out.println("Cuanto la clave del trabajador?");
